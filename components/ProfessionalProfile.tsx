    ...
    return (
        <div>
            <header className="mb-8">
                ...
                <p className="text-gray-400">Visualize e edite suas informações profissionais.</p>
            </header>
            ...
            <div className="text-center bg-gray-800/50 border border-dashed border-gray-700 rounded-lg p-16">
                ...
                <p className="text-gray-400 max-w-2xl mx-auto">
                    Em breve, você poderá visualizar e editar suas informações de perfil, como especialidade, CRM, horários de atendimento e foto.
                </p>
            </div>
        </div>
    );
